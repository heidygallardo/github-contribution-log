...
---
Currently exploring issues list to select an issue that has not been taken yet. 

My top options at the moment are the following:

https://github.com/typescript-eslint/ts-api-utils/issues/12 
https://github.com/nisshchayarathi/gitverse-nextjs/issues/538

I am searching for an issue where I can either add a test or make UI updates. The stack I am aiming for is JavaScript, Vue, HTML, and CSS.
